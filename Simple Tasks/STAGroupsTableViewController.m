...
{
    STANewGroupViewConrtoller * addNewGroupVC = [[STANewGroupViewConrtoller alloc] init];
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////// subclass UIViewcontroller . . . name it STANewGroupViewConrtoller
    // add text field for group name  √
    // add 2 buttons on it for cancel and save   √
    // pass (with a property) the groups array to the VC (new groupviewcontroller)   √
    // save creats NSMutableDictionary and adds it to the groups array
    // save andcancel "dismiss" the VC
